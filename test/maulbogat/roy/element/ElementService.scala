...
import maulbogat.roy.element.ElementRegistry.{Earth, Fire, Wind}
...
object ElementRegistry extends Enumeration with ObligatedRegistry with GenericRegistry[Element] {
